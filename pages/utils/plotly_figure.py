...
import dateutil
import pandas as pd # Inferred from 'pandas ta as pta'
import datetime
...
def plotly_table(dataframe):
    ...
    fig = go.Figure(data=[go.Table(
        header=dict(
            # Note: The variable 'b' in the line below appears to be a typo
            # in the original image, as 'i' is the loop variable.
        ...
        cells=dict(
            # Note: The 'fill_color' list is incomplete as it's cut off in the image.
            values=['<b>'+str(i)+'<b>' for i in dataframe.index]+[dataframe[i] for i in dataframe.columns], fill_color = [[rowOddColor,rowEve
